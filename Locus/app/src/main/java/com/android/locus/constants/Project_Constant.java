package com.android.locus.constants;

/**
 * Created by vishal.kumar1 on 03/10/16.
 */
...
public class Project_Constant {
    ...
    public static final int RadiusShoppingMall=2000;
    public static final int RadiusHospital=1000;
    public static final int MaxResturant=10;
    public static final int MaxPolice=2;
    public static final int MaxShoppingMall=4;
    public static final int MaxHospital=5;
